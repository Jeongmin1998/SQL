...
SELECT yr year, subject, winner FROM nobel
...
SELECT winner winners, yr year, subject
FROM nobel
...
**오늘 알게 된 것**
- Apostrophe가 포함된 것 찾기: double up the single quote within it
예) EUGENE O'NEILL --> 'EUGENE O''NEILL'
